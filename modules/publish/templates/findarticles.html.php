    ...
    <tr>
        ...
        <td class="main_area article">
            ...
            <form action="<?php echo (\thebuggenie\core\framework\Context::isProjectContext()) ? make_url('publish_find_project_articles', array('project_key' => \thebuggenie\core\framework\Context::getCurrentProject()->getKey())) : make_url('publish_find_articles'); ?>" method="get" accept-charset="<?php echo \thebuggenie\core\framework\Context::getI18n()->getCharset(); ?>">
                <label for="find_article_name" style="font-size: 1.1em; float: left;"><?php echo __('Find articles by name'); ?></label><input type="text" name="articlename" id="find_article_name" value="<?php echo \thebuggenie\core\framework\Context::getI18n()->__e($articlename); ?>" style="width: 400px; float: left; margin-left: 5px; padding: 2px; font-size: 1.3em;">
                ...
                <?php if ($resultcount): ?>
                    ...
                    <ul class="simple_list wiki-find-articles-list">
                        ...
                        <li style="margin-bottom: 0;">
                            <?php echo link_tag(make_url('publish_article', array('article_name' => $article->getName())), get_spaced_name($article->getName()), array('style' => 'font-size: 1.1em;')); ?><br>
